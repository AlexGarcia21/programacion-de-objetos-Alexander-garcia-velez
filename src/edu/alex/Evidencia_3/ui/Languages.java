package edu.alex.Evidencia_3.ui;
    ...
    public static void getInstance(String language) {
        ...
        switch (opcion) {
            ...
            case ESP:
                ...
                NOMBRES = "Ingrese el nombre del Jugador: ";
                ...
                AFIRMATIVO = "s";
                NEGATIVO = "n";
                TABLA_VACIA = "la tabla esta vacia\n";
                DESPEDIDA = "\nGracias por jugar, Nos vemos luego!\n";
                JUGADOR_1 = "jugador 1";
                JUGADOR_2 = "jugador 2";
                LENGUAGE_INVALIDO = "Lenguaje invalido";
                break;
