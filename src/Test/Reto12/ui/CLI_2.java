package Test.Reto12.ui;

import edu.alex.reto9.process.*;
import edu.alex.reto9.ui.Traductor;
...
public class CLI_2 {
    public void run() {
        ...
        do {
            ...
            if (opcion == 1) {
                edu.alex.reto9.ui.Traductor traductor = edu.alex.reto9.ui.Traductor.getInstance("es");
                System.out.println(traductor.HOLA_Bienvenido);

                traductor = edu.alex.reto9.ui.Traductor.getInstance("opcion1");
                System.out.println(traductor.HOLA_Bienvenido);
                ...
                edu.alex.reto9.ui.Traductor traductor = edu.alex.reto9.ui.Traductor.getInstance("eng");
                System.out.println(traductor.HOLA_Bienvenido);

                traductor = edu.alex.reto9.ui.Traductor.getInstance("opcion2");
                System.out.println(traductor.HOLA_Bienvenido);

                traductor = edu.alex.reto9.ui.Traductor.getInstance("the little prince");
                System.out.println(traductor.HOLA_Bienvenido);

                traductor = edu.alex.reto9.ui.Traductor.getInstance("red riding hood");
                System.out.println(traductor.HOLA_Bienvenido);

                traductor = edu.alex.reto9.ui.Traductor.getInstance("dinosaur");
                System.out.println(traductor.HOLA_Bienvenido);

                traductor = edu.alex.reto9.ui.Traductor.getInstance("the puss in boots");
                System.out.println(traductor.HOLA_Bienvenido);
